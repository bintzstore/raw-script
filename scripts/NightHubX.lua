...
autoSection.Size = UDim2.new(1,-16,0,78); autoSection.Position = UDim2.new(0,8,0,168)
...
autoAnswerStatusLabel.Size = UDim2.new(1,-20,0,14); autoAnswerStatusLabel.Position = UDim2.new(0,10,1,-17)
...
autoToggleBtn.MouseButton1Click:Connect(function()
	...
	if AutoAnswerEnabled then
		SendNotification("auto", "Auto Detect AKTIF 🤖", "NightHubX akan otomatis mendeteksi & menjawab. Kata terpakai terfilter. Delay manusiawi.", 4)
...
divLine.Size = UDim2.new(1,-24,0,1); divLine.Position = UDim2.new(0,12,0,254)
...
tipsHeader2.Size = UDim2.new(1,-16,0,16); tipsHeader2.Position = UDim2.new(0,10,0,260)
...
local tips = {
	...
	"🤖 Auto Detect = ambil opsi teratas",
	"🚫 Kata terpakai hilang otomatis",
	"🔄 Reset list saat match baru",
	"💀 Akhiran x/z/q = KILLER!",
	"◆ Ganti tema | ⏏ = Unload",
}
for i, tip in ipairs(tips) do
	local tl = Instance.new("TextLabel", leftPanel)
	tl.Size = UDim2.new(1,-22,0,14); tl.Position = UDim2.new(0,14,0,260+(i*15))
...
verBadge.Size = UDim2.new(1,-16,0,28); verBadge.Position = UDim2.new(0,8,1,-34)
...
local function DoAutoAnswer(turnStartTime)
	...
	if autoAnswerStatusLabel then
		autoAnswerStatusLabel.Text='🤖 Mendeteksi: "'..word..'"...'
		autoAnswerStatusLabel.TextColor3=Color3.fromRGB(140,100,255)
	end
	...
	local success = HumanTypeWord(word, CurrentLetter, turnStartTime)
...
print("[NightHubX v4] SmartAuto+DupFilter+AutoDetect initialized!")
